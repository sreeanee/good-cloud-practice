<p align="center">
  <img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/logo.png" alt="Logo">
</p>
  
<p align="center">A python3 script, which scan and generate a html report about your Google Cloud Platform non compliance.
...
<div align="center">
  Maintained by
  <a href="https://www.linkedin.com/in/sreetha-aneesh-47a96130/">Sreetha Aneesh</a>
</div>

## Introduction

This tool was developed to facilitate security auditing and compliance monitoring on Google Cloud Platform.
...
```
git clone https://github.com/sreetha-aneesh/Good-Cloud-Practice
...
<img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/header.png" alt="Logo">

### Global section
With a summary of all the non compliances (only printed if there is more thant one project scan).
<img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/global.png" alt="Global">

### Report section
Print the name of the project scanned, the summary of non compliances found and the result underneath.
<img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/section.png" alt="Section">

### Results
Once the "Results" are unfold, you have three sections.
<img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/unfold_section.png" alt="Unfold section">

### Section
Here's what you can see once the "Non compliant" section is unfold.
<img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/unfold_section_two.png" alt="Unfold section two">

### Footer
And finally the footer, with some links and at the right side a "Back to the top" button.
<img src="https://github.com/sreetha-aneesh/Good-Cloud-Practice/blob/main/images/footer.png" alt="Footer">
...
Sreetha Aneesh is a Senior Full Stack Developer with over 5 years of experience in full-stack application development, backend engineering, and cloud technologies. She specializes in building secure enterprise solutions and maintaining robust software architectures across financial and technology sectors.
